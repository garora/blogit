...
namespace blogit.utility
{
    public static class Config
    {
        ...
        public static string HomePage
        {
            get
            {
                return GetConfigValueAsString("HomePage") ?? string.Empty;
            }
        }
        ...
        public static bool EnableSsl
        {
            get
            {
                return GetConfigValueAsBool("EnableSsl", false);
            }
        }
        /// <summary>
        ...
        public static bool EnableRegistration
        {
            get
            {
                return GetConfigValueAsBool("EnableRegistration", true);
            }
        }
        /// <summary>
        ...
        public static bool EnableRouting
        {
            get
            {
                return GetConfigValueAsBool("EnableRouting", false);
            }
        }
        /// <summary>
        ...
        public static string ConnectionStringName
        {
            get
            {
                return GetConfigValueAsString(string.IsNullOrEmpty(ConnStringName) ? "ConnectionStringname" : ConnStringName) ?? "cn";
            }
        }
